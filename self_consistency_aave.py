...
def main() -> None:
    aave_df, _ = load_self_consistency_frames(CHATGPT_PATH, DEEPSEEK_PATH, LLAMA_PATH)

    plot_self_consistency_heatmap(
        aave_df,
        title="Self-Consistency Heatmap - AAVE",
        outfile=ROOT / "plots" / "self_consistency_AAVE.pdf",
    )
